...
import { Loader2, Search, MapPin, ChevronLeft } from "lucide-react";
...
import { scraperJobColumns } from "@/models/commercial/scraper-job/utils";
import { commercialLeadColumns } from "@/models/commercial/lead/utils";
...
export default function ScraperPage() {
  ...
  useEffect(() => {
    const jobId = searchParams.get("scraperJobId");
      ...
      <div className="p-6 max-w-7xl mx-auto space-y-8">
        ...
        {selectedJobId ? (
          <div className="space-y-4">
            <Button
              ...
              onClick={() => {
                ...
                // remove param da url sem refresh
                window.history.pushState({}, "", "/dashboard/leads/scraper");
              }}
              className="gap-2"
            >
              <ChevronLeft className="h-4 w-4" />
              Voltar para o Scraper
            </Button>
          ...
          <>
            ...
            {/* Histórico de buscas (Admin only) */}
            {isAdmin && (
              <div>
                <h2 className="text-lg font-semibold mb-4">Histórico de Execuções</h2>
                <div className="rounded-xl border bg-card">
                  <TableView
